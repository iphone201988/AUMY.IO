...
class BookServiceDetailsVC: UIViewController {
    ...
    @IBAction func proceedToCheckout(_ sender: InterButton) {
        SharedMethods.shared.pushToWithoutData(destVC: PaymentMethodVC.self, isAnimated: true)
    }
}

// MARK: Delegates and DataSources
extension BookServiceDetailsVC: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {

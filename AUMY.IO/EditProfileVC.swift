...
class EditProfileVC: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        setFloatPlaceholderFont([nameTF, emailTF, phoneCodeTF, phoneNoTF])
        setEditableTextFieldFont([nameTF, emailTF, phoneCodeTF, phoneNoTF])
        customPlaceHolder([nameTF, emailTF, phoneCodeTF, phoneNoTF])
    }
